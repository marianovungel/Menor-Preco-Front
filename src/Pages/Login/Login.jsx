  ...
  return (
    <div className='fullContentLogin'>
        ...
        <div className="loginForm">
            <div className="logo">
                <img src="./logo-sem-fundo.png" alt="" className="logoLoginImg" />
            </div>
            ...
            {create === "Coop" ? (
                <div className="formLogin">
                    <div className="shoose">
                        <div className="cooperativaLogin" id={colorCoop} onClick={setTypeCoop}>Cooperativa</div>
                        <div className="UserLogin" id={colorUse} onClick={setTypeUse}>Usuário</div>
                    </div>
                    <div className="inputs">
                        <input type="text" placeholder={type === "Coop" ? "Cooperativa" : "Usuário"} className='input Cooperativa' onChange={(e)=>setUser(e.target.value)} />
